...
def solve_head_losses(flowrates):
    ...
    residuals = [
        ...
        # Pump
        hl1(totalflow) + hl2(fl1 + fl2 + fl3 + fl4 + fl5 + fl6) + hl3(fl1) - pump_curve_C(totalflow)*16
        # We know from assume_1_gpm_last_sink.py that we need minimum 16 C pumps and that those will be most
